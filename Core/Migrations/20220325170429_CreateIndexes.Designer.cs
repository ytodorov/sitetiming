...
namespace Core.Migrations
{
    ...
    [Migration("20220325170429_CreateIndexes")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.ConsoleMessageEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Entities.ProbeEntity", b =>
                {
                    ...
                    b.Property<string>("DestinationIpAddressCity")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("DestinationIpAddressCountry")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("DestinationIpAddressHostname")
                        .HasColumnType("nvarchar(max)");

                    b.Property<double?>("DestinationIpAddressLatitude")
                        .HasColumnType("float");

                    b.Property<double?>("DestinationIpAddressLongitude")
                        .HasColumnType("float");

                    b.Property<string>("DestinationIpAddressOrg")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("DestinationIpAddressPostal")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("DestinationIpAddressRegion")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("DestinationIpAddressTimezone")
                        .HasColumnType("nvarchar(max)");

                    b.Property<double?>("DistanceBetweenIpAddresses")
                        .HasColumnType("float");
                    ...
                    b.Property<string>("SourceIpAddressCity")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("SourceIpAddressCountry")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("SourceIpAddressHostname")
                        .HasColumnType("nvarchar(max)");

                    b.Property<double?>("SourceIpAddressLatitude")
                        .HasColumnType("float");

                    b.Property<double?>("SourceIpAddressLongitude")
                        .HasColumnType("float");

                    b.Property<string>("SourceIpAddressOrg")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("SourceIpAddressPostal")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("SourceIpAddressRegion")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("SourceIpAddressTimezone")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasIndex("DestinationIpAddress");

                    b.HasIndex("SiteId");

                    b.HasIndex("SourceIpAddress");
